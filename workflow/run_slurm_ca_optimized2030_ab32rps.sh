...
#SBATCH -A sjdavis
#SBATCH -p serc
#SBATCH -o /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_optimized2030_ab32rps.out
#SBATCH -e /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_optimized2030_ab32rps.err
...
/home/users/wmcneil/envs/pypsa-usa/bin/snakemake \
  ...
  --jobs 20 \
  --latency-wait 60 \
  --configfile config/config.ca_optimized2030_ab32rps.yaml \
  --nolock \
  --rerun-incomplete
