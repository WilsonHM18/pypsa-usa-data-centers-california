...
#SBATCH -A sjdavis
#SBATCH -p serc
#SBATCH -o /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_ref2025.out
#SBATCH -e /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_ref2025.err
...
/home/users/wmcneil/envs/pypsa-usa/bin/snakemake \
  ...
  --jobs 20 \
  --latency-wait 60 \
  --configfile config/config.ca_ref2025.yaml \
  --nolock \
  --rerun-incomplete
