...
#SBATCH -A sjdavis
#SBATCH -p serc
#SBATCH -o /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_ref2030_ab32rps.out
#SBATCH -e /home/groups/sjdavis/will/pypsa-usa/workflow/logs/snakemake_ca_ref2030_ab32rps.err
